    ...
    <div className="bg-slate-50">
      <section>
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            >
              <div className="absolute w-28 h-28 left-0 -top-20 hidden lg:block">
                <Image src="/snake-1.png" alt="logo" fill />
              </div>
              <h1
                className="relative w-fit tracking-tight text-balance mt-16 font-bold 
              !leading-tight text-gray-900 tet-5xl md:text-6xl lg:text-7xl"
              >
                Your Image on a{" "}
              ...
              <p
                className="mt-8 text-lg lg:pr-10 max-w-prose lg:text-left 
              text-balance md:text-wrap"
              >
                Capture your favourite memories with your own,
                <span className="fonr-semibold">one-of-one</span> phone case.
          ...
          <div
            className="cols-span-full lg:cols-span-1 w-full flex
          ...
          >
            <div className="relative md:max-w-xl">
              ...
              -top-20 select-none hidden sm:block xl:block"
                alt="logo"
                width={1000}
                height={1000}
              />
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the cas for two and a half month and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clean
                  </span>
                  , The case feels durable and i even got a compliment on the
                  design. Had the cas for two"
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <Image
                  ...
                  width={100}
                  height={100}
                  className="rounded-gull h-12 w-12 object-cover rounded-full"
                />

      ...
      >
        ...
        >
          <AspectRatio
            ref={phoneCaseRef}
            ratio={896 / 1831}
            className="pointer-event-none relative z-50 aspect-[896/1831] w-full "
          >
            <NextImage
              alt="phone image"
          ...
          <div
            className="absolute z-40 inset-0 left-[px] top-px
              right-[3px] bottom-px rounded-[32px] 
              shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]"
          />
          <div
            className={cn(
              "absolute inset-0 left-[3px] top-px bottom-px rounded-[32px]",
              `bg-${options.color.tw}`
            )}
          />
        </div>
                    ...
                    {COLORS.map((color) => (
                      <RadioGroup.Option
                        ...
                        className={({ active, checked }) =>
                          cn(
                            `relative -m-.5 flex cursor-pointer 
                    items-center justify-center rounded-full p-0.5 active:ring-0
                    focus:ring-0 active:outline-none focus:outline-none border-2
                    border-transparent`,
                            {
                        ...
                        {selectableOptions.map((option) => (
                          <RadioGroup.Option
                            ...
                            className={({ active, checked }) =>
                              cn(
                                `relative
                        block cursor-pointer rounded-lg bg-white
                        px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none
                        ring-0 focus:ring-0 outilne-none sm:flex sm:justify-between`,
                                {
